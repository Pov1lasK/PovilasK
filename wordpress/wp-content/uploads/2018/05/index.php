...
<head>
    ...
    <title>Code Talents</title>

		<meta name="description" content="clean, responsive and modern"/>
		<meta name="keywords" content="responsive, html5"/>
		<meta name="author" content="codetalents.lt"/>
...
<!-- section start-page -->
    ...
    <div class="opacity"></div> <!-- Opacity color -->
      <div class="content">
        <div class="text">
          ...
          <h1>Web Talents</h1><hr/>
          <p>Sveiki atvykę, draugužiai</p>
          
          <a href="#about-us"><div class="read-more">Užeikit</div></a>
  ...
  <section class="menu-media">
    ...
    <ul class="menu-click">
        <a href="#home"><li href="#home">Pagrindinis</li></a>
        <a href="#about-us"><li href="#about-us">Apie Mus</li></a>
        <a href="#portfolio"><li href="#portfolio">Portfolio</li></a>
        <a href="#contact"><li href="#contact">Kontaktai</li></a>
  ...
  <div class="content">
    ...
    <h1>Apie Mus</h1>
    <hr/>
    <p class="title">Puslapis info sharinimui, diskusijoms, pažintims, pasimatymams, meet'as, post'ams, konfliktams ir t.t.</p>
  ...
  <section class="portfolio" id="portfolio">
          ...
          <li>
            <a href="#">
              <img src="img/portfolio/6.png" alt="Portfolio item" />
                <div class="text">
                  <p>Pvz2</p> 
                  <p class="description">Tautvydas</p>           
              </div>
            </a>
          </li>         
   ...
   <a href="#"><div class="read-more">Skaityti daugiau...</div></a>
   ...
   <div class="clear"></div>  
    ...
    <section class="contact" id="contact">
        ...
        <div class="content">
          ...
          <strong>Povilas Kungys</strong><br/><br/>

          e-mail: <strong>povilas294@gmail.com</strong>
    ...
    <section class="footer">
        ...
        <div class="menu-footer">
          ...
          <a href="#">RSS</a>
          <a href="https://www.facebook.com/limpopoooo">Facebook</a>
          <a href="#">Instagram</a>
          <a href="#">Twitter</a>
          <a href="#">Contact</a>
        ...
        <div class="copyright">© 2018. Visos teisės saugomos webtalents.lt</div>        
